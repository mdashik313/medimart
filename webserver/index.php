...
<body>
    ...
    <form method="post">
        ...
        <div>
            <?php
                if (isset($_POST['enter'])) {
                    ...
                    echo $patient_userName. ' '. $patient_pass;
                    $select = " SELECT * FROM user WHERE name = '$patient_userName' && password = '$patient_pass' ";
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        $_SESSION['patient_rfid'] = $row['patient_rfid'];
        ...
        <input name="patient_userName" type="text" placeholder="Username" id="username">
        <input name="patient_pass" type="password" placeholder="PIN" id="pass">
